...
import com.culfoshe.constant.ItemSellStatus;
...
public class Location {
    ...
    @Column(name = "store_phoneNum", nullable = false)
    private String phoneNum;    //연락처

    @Column(name = "store_runTime")
    private String runTime;  //영업시간
...
//    private int saveNum;    //저장수
    ...
    private int reservationPossible;    //예약 가능 여부?

    @Enumerated(EnumType.STRING)
    private ItemSellStatus locationSellStatus;  //상품 예약 상태
